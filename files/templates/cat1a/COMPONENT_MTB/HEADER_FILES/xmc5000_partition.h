#if !defined(XMC5000_PARTITION_H)
#define XMC5000_PARTITION_H

#if defined (CY_DEVICE_SERIES_XMC5100)   /* *** XMC5100*** */
...
#elif defined (CY_DEVICE_SERIES_XMC5200) /* *** XMC5200 *** */
...
#elif defined (CY_DEVICE_SERIES_XMC5300) /* *** XMC5300 *** */
...
#else
#error "XMC5000 partition file was included, but no device was detected."
#endif
...
/* Flash sector size */
#define XMC5000_FLASHC_SECTOR_SIZE         0x8000
#if (CM0PLUS_CODE_FLASH_RESERVE % XMC5000_FLASHC_SECTOR_SIZE != 0)
#warning "The xmc5000_partition.h defines CM0PLUS_CODE_FLASH_RESERVE to a value that does not land on a flash boundary.  This will cause partial erasure of the beginning of CM4 application anytime the CM0+ application is flashed."
#endif
