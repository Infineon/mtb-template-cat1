...
################################################################################
# \copyright
# (c) 2018-2026, Infineon Technologies AG or an affiliate of Infineon Technologies AG.
...
export VECT_SIZE_CM4     := 0x000002F8
export TEXT_BASE_CM4     := 0x100022F8
export TEXT_SIZE_CM4     := 0x0007E000
export RAM_BASE_CM4      := 0x080022F8
export RAM_SIZE_CM4      := 0x0003D800
